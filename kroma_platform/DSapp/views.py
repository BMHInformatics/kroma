...
CLINICIAN_INSTRUCTION = (
    ...
    "contextualize and ground your answers, but do not quote individual triples in your main answer. "
    ...
    "IMPORTANT: In your main answer (i.e., the first portion of your response, which is the [[ANSWER]] portion),"
    "do NOT mention the knowledge graph at all, and do NOT say 'the KG does/does not contain...' or similar. "
    ...
    "3) In the first portion of your response (the [[ANSWER]] portion), do NOT show or reference any raw KG identifiers,"
    "URIs, URLs, angle-bracket tokens, or strings like 'http://', 'https://', 'example.org', '<...>', 'KG-grounded:',"
    "'subject/predicate/object', or 'triple(s)'.\n"
    "4) Always provide the raw N-Triples from the KG that you used to answer the user's question, in the third portion"
    "(i.e., the [[RAW_TRIPLES]] portion) of your output."
...
def _split_kroma_sections(text: str):
    """
    Robustly split KroMA output into ANSWER, KG_SUMMARY, RAW_TRIPLES
    even if markers have whitespace or formatting noise.
    """
    sections = {
        "answer": "",
        "kg_summary": "",
